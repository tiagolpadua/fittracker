  ...
  Widget _buildTimerDisplay() {
    return StreamBuilder<int>(
      ...
      builder: (context, snapshot) {
        print('Rebuilding _buildTimerDisplay with ${snapshot.data} seconds');
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    color: remainingSeconds <= 10 ? Colors.red : Colors.black87,
                  ),
                ),
              ],
            ),
        ...
        return Row(
          ...
          children: [
            ...
            FloatingActionButton.large(
              ...
              child: Icon(isRunning ? Icons.pause : Icons.play_arrow, size: 40),
            ),
            SizedBox(width: 20),
            FloatingActionButton(
              heroTag: 'skip',
              onPressed: isRunning
                  ...
                  : null,
              backgroundColor: isRunning ? Colors.orange : Colors.grey[300],
